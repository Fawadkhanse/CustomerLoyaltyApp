...
fun ResetPasswordScreenRoute(
    ...
    ResetPasswordScreen(
        onResetPassword = { email, newPassword, confirmPassword, userType ->
            val request = ResetPasswordRequest(uid = response?.uid?:"", token = response?.token?:"", newPassword, confirmPassword)
...
private fun ResetPasswordScreen(
    ...
    var email by remember { mutableStateOf(response?.email?:"") }
...
fun ResetPasswordScreenPreview() {
    MaterialTheme {
        ResetPasswordScreen(
            ...
            onBack = {},
            onResetSuccess = TODO(),
            resetPasswordState = TODO(),
            promptsViewModel = TODO(),
            response = TODO(),
        )
    }
}